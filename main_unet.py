"""
This source code is written for applying unet based on pure pytorch.
...
from fastmri.modules import FastMriDataModule, UnetModule

# TODO : create module by torch (replace pl_module)

def cli_main(args):
    # Setting seed
    seed = 42
    torch.manuual_seed(seed)
